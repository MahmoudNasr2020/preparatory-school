...
if ($fetch['status'] == 1) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($select1 == 1) {
            $selectstd1 = $con->prepare("SELECT * FROM studentatt WHERE idnumber=$name1");
            $selectstd1->execute();
        ...
        if ($select1 == 2) {
            $selectstd2 = $con->prepare("SELECT * FROM studentatt2 WHERE idnumber=$name1");
            $selectstd2->execute();
        ...
        if ($select1 == 3) {
            $selectstd3 = $con->prepare("SELECT * FROM studentatt3 WHERE idnumber=$name1");
            $selectstd3->execute();
            $row3 = $selectstd3->rowCount();
            if ($row3 > 0) {
                $fetch3 = $selectstd3->fetch();
                $sucess3 = 'success';
            } else {
                $error3 = 'رقم الجلوس غير موجود';
            }
        }
    }
    ?>
                ...
                <div class="container-fluid custom-container">
                    ...
                    <div class="row">
                        <div class="col-md-12 " style='margin-top: -36px;'>
                            ...
                            <h2 class="area-heading font-orange st-two">الغياب</h2>
                        </div>
                    </div>
...
if (isset($sucess)) {?>
                            <br><table class="table table-dark">
                                ...
                                <table class="table table-dark">
                                    <tbody>
                                    <tr>
                                    <th scope="row">عدد ايام الغياب</th>
                                    <td><?php echo $fetch1['numberatt']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                         <?php }
...
if (isset($sucess2)) {?>
                            <br><table class="table table-dark">
                                ...
                                <table class="table table-dark">
                                    ...
                                    <tr>
                                    <th scope="row">عدد ايام الغياب</th>
                                    <td><?php echo $fetch2['numberatt']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                         <?php }
...
if (isset($sucess3)) {?>
                            <br><table class="table table-dark">
                                    ...
                                    <tr>
                                    <th scope="row">رقم الجلوس</th>
                                    <td><?php echo $fetch3['idnumber']; ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                                <table class="table table-dark">
                                    ...
                                    <tr>
                                    <th scope="row">عدد ايام الغياب</th>
                                    <td><?php echo $fetch3['numberatt']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                         <?php }
