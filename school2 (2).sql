...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2020 at 09:42 PM
...
(13, 'عاااااااااااااااااااجل', '&#34; مصدر باتحاد الكرة يكشف أسباب طلب بعض الأندية إلغاء الدوري', 'layout/img/news/990137577_Untitled-11.jpg', '2020-04-26'),
...
(8, 'الغياب', 'result/attanced.html', 'layout/img/service/الغياب.png'),
...
(14, 'اتصل بنا', 'Contact\\contact.html', 'layout/img/service/اتصل بنا.png');
...
(1, 'مدرسة ميدوم الاعدادية بنين', 'm60161515@gmail.com', '01127421485', 'ميدوم-الواسطي-بني سويف', 1);
...
(5, 105, 'احمد نصر جمعة', 150, 1),
(6, 1879, 'يوسف احمد صديق محمود', 8000, 2),
(8, 100000000, 'احمد محمد', 150, 3);
...
(1, 10, 'احمد نصر جمعة', 10, 1),
(3, 122, 'سماء احمد صديق محمود', 15, 3);
...
(3, 52, 'احمد نصر جمعة', 250, 240, 400, 500, 800, 10, 20, 30, 40, 50, 1),
(4, 150, 'محمود نصر', 74.5, 70, 53.9, 80, 50, 10, 10, 10, 10, 10, 2),
(5, 233, 'احمد رافت ابراهيم', 50, 100, 80, 90, 70, 100, 100, 80, 80, 90, 1);
...
(1, 15, 'احمد نصر جمعة', 100, 55, 80, 90, 100, 150, 0, 0, 48, 10, 1),
(3, 80, 'احمد نصر جمعة', 70, 90, 100, 150, 41, 0, 0, 10, 20, 10, 1),
(4, 1457, 'احمد نصر جمعة', 55, 80, 70, 10, 80, 70, 0, 0, 0, 0, 3);
...
(5, 'مصطفي عيسي', 'اللغة الانجليزية', 'layout/img/teacher/teacher.jfif'),
