...
$select = $con->prepare("SELECT * FROM aboutschool WHERE id=1");
$select->execute();
$fetch = $select->fetch();
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="">عن المدرسة</a></li>
                        ...
                        <div class="logo-header mostion">
                            <a href="index-2.html" class="dez-page"><img src="layout/images/logo3.png" alt=""></a>
                        </div>
                        <!-- nav toggle button -->
